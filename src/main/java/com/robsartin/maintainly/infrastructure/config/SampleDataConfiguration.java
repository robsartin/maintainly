...
public class SampleDataConfiguration {
    ...
    public CommandLineRunner loadSampleData(
        ...
        return args -> {
            if (orgRepo.findById(1).isPresent()) {
            ...
            createProperty(propRepo, org.getId(),
                    "123 Main St", "123 Main St, Springfield",
                    LocalDate.now().plusDays(3));
            createProperty(propRepo, org.getId(),
                    "456 Oak Ave", "456 Oak Ave, Shelbyville",
                    LocalDate.now().plusDays(10));
            createProperty(propRepo, org.getId(),
                    "789 Pine Rd", "789 Pine Rd, Capital City",
                    LocalDate.now().minusDays(2));
        };
    }

    private void createProperty(
            PropertyRepository repo, int orgId,
